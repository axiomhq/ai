...
declare class InvalidArgumentError extends AISDKError {
  ...
  constructor({ message, cause, argument }: { argument: string; message: string; cause?: unknown });
...
declare class InvalidPromptError extends AISDKError {
  ...
  constructor({ prompt, message, cause }: { prompt: unknown; message: string; cause?: unknown });
...
declare class UnsupportedFunctionalityError extends AISDKError {
  ...
  constructor({ functionality, message }: { functionality: string; message?: string });
...
export {
  ...
  type LanguageModelV1RedactedReasoningPart,
  type LanguageModelV1Source,
  type LanguageModelV1StreamPart,
