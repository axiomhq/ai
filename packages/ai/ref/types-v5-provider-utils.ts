...
declare function combineHeaders(
 ...
 */
declare function convertAsyncIteratorToReadableStream<T>(
 ...
 */
declare const createIdGenerator: ({
  prefix,
  size: defaultSize,
  alphabet,
  separator,
 ...
 */
declare function parseJSON(options: { text: string; schema?: undefined }): JSONValue;
/**
 ...
 */
declare function parseJSON<T>(options: { text: string; schema: ZodSchema<T> | Validator<T> }): T;
type ParseResult<T> =
  | {
      success: true;
      value: T;
...
declare const createJsonStreamResponseHandler: <T>(
  chunkSchema: ZodSchema<T>,
) => ResponseHandler<ReadableStream<ParseResult<T>>>;
 ...
 */
declare function loadOptionalSetting({
  settingValue,
  environmentVariableName,
}: {
...
declare function parseProviderOptions<T>({
  provider,
  providerOptions,
  schema,
}: {
...
declare const postFormDataToApi: <T>({
  url,
  headers,
  formData,
  failedResponseHandler,
 ...
 */
declare function removeUndefinedEntries<T>(
 ...
 */
declare function validateTypes<T>({
  value,
  schema: inputSchema,
}: {
  value: unknown;
 ...
 * @returns An object with either a `success` flag and the parsed and typed data, or a `success` flag and an error object.
 */
declare function safeValidateTypes<T>({
  value,
  schema,
}: {
  value: unknown;
