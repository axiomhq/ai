...
export const obsCommandSpec = {
  ...
  commands: [
    ...
    },
    {
      ...
      subcommands: [
        { name: 'list', description: 'List services seen in traces' },
        { name: 'get', description: 'Show service status summary', args: '<service>' },
        { name: 'operations', description: 'List operations for a service', args: '<service>' },
        { name: 'traces', description: 'List recent traces for a service', args: '<service>' },
        { name: 'logs', description: 'Show recent logs for a service (if available)', args: '<service>' },
    ...
    },
    {
      ...
      subcommands: [
        { name: 'list', description: 'Search recent traces' },
        { name: 'get', description: 'Show a trace tree view plus key span table', args: '<trace-id>' },
        { name: 'spans', description: 'Show spans as a table', args: '<trace-id>' },
      ],
    },
