...
import { wrapTool, wrapTools, type WrappedTool } from '../../src/otel/wrapTool';
...
describe('wrapTool', () => {
  ...
  it('should handle tool without execute method', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith('Cannot wrap a tool that does not have an execute method');
