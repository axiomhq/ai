...
describe("MockProvider Example Usage", () => {
  ...
  describe("Language Model Tests", () => {
    ...
    it("should handle multiple responses (conversation simulation)", async () => {
      ...
      mockProvider
        ...
        .addLanguageModelResponse(
          "chat-model",
          mockResponses.text("How can I help you?")
        )
        .addLanguageModelResponse(
          "chat-model",
          mockResponses.text("Sure, I can do that.")
        );
    ...
    it("should simulate errors and warnings", async () => {
      ...
      expect(
        (result.warnings?.[0] as { type: "other"; message: string })?.message
  ...
  describe("Image Model Tests", () => {
    it("should generate images", async () => {
      ...
      mockProvider.addImageResponse(
        "image-model",
        mockResponses.image(customBase64)
      );
  ...
  describe("Provider Management", () => {
    ...
    it("should throw on missing responses when configured strictly", async () => {
      ...
      await expect(
        ...
        "No mock response configured for language model: unconfigured-model"
      );
    });
  });
  ...
  describe("Advanced Scenarios", () => {
    it("should simulate reasoning responses", async () => {
      ...
      expect(result.reasoning).toBe(
        "Let me think about this...After careful consideration..."
      );
    });
    ...
    it("should work with feature test suite capabilities", () => {
      ...
      provider
        .addLanguageModelResponse(
          "mock-model",
          mockResponses.text("Text generation works")
        )
        .addLanguageModelResponse(
          "mock-model",
        ...
        .addStreamResponse(
          "mock-model",
          mockResponses.stream(["Streaming", " works"])
        )
